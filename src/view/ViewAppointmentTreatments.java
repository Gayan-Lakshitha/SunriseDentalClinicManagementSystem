 ...
 * @author DELL
 */
public class ViewAppointmentTreatments extends javax.swing.JFrame {
    
    private int appointmentNo;

    /**
     * Creates new form ViewAppointmentTreatments
     */
    public ViewAppointmentTreatments(int appointmentNo) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       AddTreatment add = new AddTreatment(0);
       add.setVisible(true);
       this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAppointmentTreatments.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAppointmentTreatments(1).setVisible(true);
            }
        });
    }
